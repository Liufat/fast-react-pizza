...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      " border-2 border-stone-300 uppercase font-semibold text-sm text-stone-400 inline-block tracking-wide rounded-full hover:bg-stone-300 hover:text-stone-800 transition-colors duration-300 focus:outline-none focus:ring focus:ring-stone-200 focus:bg-stone-300 focus:text-stone-800 focus:ring-offset-2 disabled:cursor-not-allowed md:px-6 md:py-4 py-2.5 px-4",
  };
